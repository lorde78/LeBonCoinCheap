...
class ArticleRepository extends ServiceEntityRepository {
  ...
  public function remove( Article $entity, bool $flush = false )
  : void {
   ...
   * @return Article[] Returns an array of Article by idTag objects
   */
  public function findByIdTagAndByIdArticle( $idArticle )
  : array {
    return $this->createQueryBuilder( 'a' )
  ...
  public function findByTotalQuestion() {
    return $this->createQueryBuilder( 'a' )
        /*                ->innerJoin( 'a.questions', 'q' )
                        ->addSelect( 'questions' )*/
                ->innerJoin( 'a.questions', 'q' )
                ->orderBy( 'q.logVote', 'DESC' )
                ->addSelect( 'q' )
                ->setMaxResults( 4 )
                ->getQuery()
                ->getResult();
   ...
   */
  public function findArticlesByName( string $search = null )
  : QueryBuilder {
